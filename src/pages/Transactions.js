                    ...
                    >
                      <div className="w-auto px-4" style={{ width: 150 }}>
                        <img
                          ...
                          alt={item?.metadata?.course_thumbnail ?? "Class Name"}
                        />
                      </div>
                      ...
                      <div className="w-2/12 px-4">
                        <h6 className="text-gray-900 text-lg">
                          Rp.{" "}
                          {fortmatThousand(item?.metadata?.course_price ?? 0)}
                        </h6>
                      </div>
                      <div className="w-2/12 px-4">
                        <h6 className="text-gray-900 text-lg">
                      ...
                      <div className="w-3/12 flex justify-center px-4">
                        {item?.status === "pending" && (
                          <Link
                            className="bg-orange-500 hover:bg-orange-400 transition-all duration-200 text-white focus:outline-none px-6 py-3 mt-4"
